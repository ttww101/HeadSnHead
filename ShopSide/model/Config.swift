...
struct Config {
    ...
    struct Test {
        static let products: [Product] = [
            Product(name: "NIKE X SHOE DOG CORTEZ '72 QS", surname: "", avatar: UIImage(named: "1.jpg")!, availableCount: 20, color: "WHITE / VARSITY RED / GAME ROYAL", description: "This product is offered in men's sizing. There is an approximate 1.5-size difference between men's and women's sizing. For example, a women’s size 8.5 is roughly equivalent to a men’s size 7."),
