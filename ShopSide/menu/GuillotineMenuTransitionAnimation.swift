...
open class GuillotineTransitionAnimation: NSObject {
  ...
  fileprivate var vectorDY: CGFloat = 5000
  fileprivate var fromYPresentationLandscapeAdjustment: CGFloat = 0.5
  fileprivate var fromYDismissalLandscapeAdjustment: CGFloat = 0.5
  fileprivate var toYDismissalLandscapeAdjustment: CGFloat = 0.5
  fileprivate var fromYPresentationAdjustment: CGFloat = 0.5
  fileprivate var fromYDismissalAdjustment: CGFloat = 0.5
  fileprivate var toXPresentationLandscapeAdjustment: CGFloat = 0.5
