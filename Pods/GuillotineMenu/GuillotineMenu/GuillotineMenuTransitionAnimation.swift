...
open class GuillotineTransitionAnimation: NSObject {
  ...
  open var animationDuration = 0.04
  ...
  fileprivate let menuElasticity: CGFloat = 0.42
  fileprivate let vectorDYCoefficient: Double = 15 / Double.pi
  fileprivate let menuDensity: CGFloat = 7.7
